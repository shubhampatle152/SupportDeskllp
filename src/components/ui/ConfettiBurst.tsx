...
const ConfettiPiece: React.FC<ConfettiPieceProps> = ({ initialX, initialY, color }) => {
...
export default function ConfettiBurst({ isActive, onAnimationComplete }: ConfettiBurstProps) {
