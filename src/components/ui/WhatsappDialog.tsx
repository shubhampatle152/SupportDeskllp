...
import { generateInitialMessage, type GenerateInitialMessageInput } from "@/ai/flows/whatsapp-message-assistance";
...
export default function WhatsappDialog({ isOpen, onOpenChange }: WhatsappDialogProps) {
  ...
  const handleGenerateMessage = async () => {
    ...
    setGeneratedMessage("");
    try {
      const input: GenerateInitialMessageInput = { topic };
